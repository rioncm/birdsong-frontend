...
const SettingsDialogPage: React.FC = () =&gt; (
  &lt;&gt;
              ...
              dark:border-neutral-700">
                <div classname="items-start flex space-x-3">
                  <div classname="mt-1 flex-shrink-0">
                    <svg class="w-5 h-5 text-neutral-600 dark:text-neutral-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" id="Windframe_OJVErEshjKe">
